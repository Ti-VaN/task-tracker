...
import danil.tiv.task.tracker.factories.TaskStateDtoFactory;
import danil.tiv.task.tracker.store.entities.ProjectEntity;
import danil.tiv.task.tracker.store.entities.TaskStateEntity;
import danil.tiv.task.tracker.store.repositories.TaskStateRepository;
...
public class TaskStateController {
    ...
    public TaskStateDto changeTaskStatePosition(
            @PathVariable(name = "task_state_id") Long taskStateId,
            @RequestParam(name = "optionalLeftTaskStateId") Optional<Long> optionalLeftTaskStateId) {
